...
import { useOrgSlideOver } from "@lms/components/composables/lsp-data-table/OrganizationLspDataTable";

export const OrgAvatarWithAppwriteUpload: FunctionComponent<AvatarProps> = ({
  source,
  alt = "avatar",
  size = "md",
  roundedness = "full",
  ...
  const { setUploadAlertIsOpen } = useOrgSlideOver();
