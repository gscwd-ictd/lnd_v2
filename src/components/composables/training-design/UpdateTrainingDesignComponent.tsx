...
export const UpdateTrainingDesignComponent: FunctionComponent = () => {
  ...
  const onNext = () => {
    ...
    } else if (page === 2) tdDataTableMutation.mutate();
  };
  ...
  const tdDataTableMutation = useMutation({
    onSuccess: (data) => {
      ...
      push(`/trainings/design`);
      queryClient.setQueryData(["training-designs"], (oldData: any) => {
      ...
      <div className="p-10 mt-5 bg-white border rounded">
        <div className="flex items-center justify-between w-full text-center">
          <div className="text-left">
            <div className="text-2xl font-medium text-gray-700">Update Training Design</div>
