...
import { useIndSlideOver } from "../IndividualLspDataTable";
import axios from "axios";
import { url } from "@lms/utilities/url/api-url";
import { Avatar } from "@lms/components/osprey/ui/avatar/view/Avatar";
import { IndAvatarWithAppwriteUpload } from "@lms/components/osprey/ui/avatar/view/IndAvatarWithAppwriteUpload";
import { Spinner } from "@lms/components/osprey/ui/spinner/view/Spinner";

export const IndividualLspSlideOver = () => {
  ...
  const { id: rowId, slideOverIsOpen, setSlideOverIsOpen, setId } = useIndSlideOver();
  ...
  const {
    ...
    queryKey: ["lsp-individual-details", rowId],
    queryFn: async () => {
      ...
      <SlideOver.Body>
        <div className="px-10 py-2 pt-5">
          {source === "internal" ? (
            ...
            <IndAvatarWithAppwriteUpload source={allLsp?.photoUrl ? allLsp?.photoUrl : defaultPhoto.src} size="9xl" />
          ) : null}
