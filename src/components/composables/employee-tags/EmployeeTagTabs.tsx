      ...
      <TabContentWrap>
        <TabsContent value="tab1">
          ...
          {/* {selectedEmployee?.employeeId ? (
            <div className="border-2 rounded border-indigo-600 m-2 mx-6 p-5 bg-indigo-50 flex gap-2 justify-between items-center">
              <div className="text-slate-600 font-medium flex gap-2 items-center">
                <HiTag />
                {selectedEmployee ? selectedEmployee.fullName : "None"}
              </div>
              <button
