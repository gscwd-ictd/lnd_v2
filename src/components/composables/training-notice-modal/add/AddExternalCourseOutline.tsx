...
export const AddExternalCourseOutline: FunctionComponent = () => {
  ...
  const [selectedLspType, setSelectedLspType] = useState<"individual" | "organization">("organization");
  ...
  const {
    ...
    setError,
    formState: { errors },
  } = useForm({ resolver: yupResolver(externalSchema), mode: "onChange" });
