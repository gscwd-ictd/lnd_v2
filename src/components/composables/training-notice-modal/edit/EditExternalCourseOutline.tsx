...
const externalSchema = yup.object({
...
export const EditExternalCourseOutline: FunctionComponent = () => {
  ...
  const {
    ...
    defaultValues: { courseTitle, courseContent, facilitators: selectedFacilitators },
  ...
  useQuery({
    ...
    // enabled: selectedFacilitators.length === false,
    // enabled: !!lspSource,
    queryFn: async () => {
    ...
    <>
      <form id="externalCourseOutlineForm" key="externalCourseOutlineForm" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mt-1">
          ...
          {/* {JSON.stringify(filteredFacilitators)} */}
          <div className="relative">
            ...
            >
              ...
              <Combobox.Options className="absolute max-h-52 z-[80] overflow-y-auto bg-white w-full border rounded-md shadow-lg shadow-gray-100">
                ...
                {filteredFacilitators && filteredFacilitators?.length === 0 ? (
