...
const schema = yup.object({
  ...
  trainingEnd: yup
    ...
    .required("Date is required"),
  numberOfHours: yup.number().typeError("Should not be empty").min(1, "Invalid input!").required(),
...
export const TrainingInformation: FunctionComponent = () => {
  ...
  const setDeadlineForSubmission = useTrainingNoticeStore((state) => state.setDeadlineForSubmission);
            ...
            <div className="w-full pb-2 ">
              ...
              <input
                ...
                {...register("trainingStart", {
                  value: trainingStart,
                  onChange: (e) => {
                    setDeadlineForSubmission(e.target.value);
