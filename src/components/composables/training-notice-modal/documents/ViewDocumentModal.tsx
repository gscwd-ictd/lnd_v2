      ...
      try {
        ...
        if (!isEmpty(data)) {
          ...
          setPreparedBy({
            ...
            position: "Acting Department Manager A, HR Head, PDC Secretariat", // TODO Wait for Henry's route.. Change this to dynamic data.
          });
          setNotedBy({
            name: "FERDINAND S. FERRER, MPA",
            position: "Acting General Manager / PDC Chairperson", // TODO Wait for Henry's route.. Change this to dynamic data.
          });
        }
              ...
              <PDFViewer width={"100%"} height={windowHeight}>
                <Document title=" ">
                  <Page size="A4" style={{ paddingHorizontal: 72, paddingVertical: 24 }}>
                    <PdfHeader isoCode="HRD-XXXX-X" withIsoLogo />
                    <TrainingDocumentPdf
