...
export const OnGoingSlideOverBody = () => {
  ...
  const { batches, batchAttendanceIsOpen, selectedBatch, setAlertSubmissionIsOpen } = useContext(OnGoingContext);
    ...
    <>
      <div className="flex flex-col gap-5 px-8 py-10">
        ...
        <div className="flex w-full rounded ">
          ...
          >
            <span className="text-white uppercase">For requirements submission</span>
          </button>
        </div>
      </div>
