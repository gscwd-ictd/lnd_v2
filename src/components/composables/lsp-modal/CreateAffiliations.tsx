...
export const CreateAffiliations: FunctionComponent = () => {
  const {
    register,
    setValue,
    handleSubmit,
  ...
  // on submit
  const onSubmit = () => {
    if (lspType === LspType.INDIVIDUAL) setPage(10);
    else setPage(7);
  };
  ...
  return (
    <>
      <form id="createAffiliationsForm" key="createAffiliationsForm" onSubmit={handleSubmit(onSubmit)}>
