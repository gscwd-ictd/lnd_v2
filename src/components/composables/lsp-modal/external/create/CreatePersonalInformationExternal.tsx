...
export const CreatePersonalInformationExternal: FunctionComponent = () => {
  const {
    register,
    handleSubmit,
    setValue,
  ...
  return (
    <>
      <form id="createPersonalInfoExternalForm" key="createPersonalInfoExternalForm" onSubmit={handleSubmit(onSubmit)}>
        <div className="">
              ...
              {({ checked }) => {
                ...
                return (
                  <div
                    className={`${
                      checked ? "bg-indigo-500 text-white font-medium" : "bg-white text-gray-600"
                    } cursor-pointer px-4 py-1 border rounded flex items-center justify-between hover:bg-indigo-300 hover:text-whitetransition-transform`}
                    onClick={() => {
                      setSex(Sex.FEMALE);
                      setValue("sex", "Female");
                    }}
