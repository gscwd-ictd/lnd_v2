...
export const CreateContactInformationExternal: FunctionComponent = () => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const onSubmit = () => {
    ...
    else if (lspType === LspType.INDIVIDUAL) setPage(4);
  };

  return (
    <>
      <form id="createContactInfoExternalForm" key="createContactInfoExternalForm" onSubmit={handleSubmit(onSubmit)}>
        <div>
