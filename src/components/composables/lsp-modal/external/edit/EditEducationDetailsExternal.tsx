...
export const EditEducationDetailsExternal: FunctionComponent = () => {
  const {
    register,
    setValue,
    handleSubmit,
  ...
  return (
    <>
      <form id="editEducDetailsExternalForm" key="editEducDetailsExternalForm" onSubmit={handleSubmit(onSubmit)}>
