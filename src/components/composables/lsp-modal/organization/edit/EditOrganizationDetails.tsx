...
export const EditOrganizationDetails: FunctionComponent = () => {
  ...
  const {
    ...
    defaultValues: { organizationName, experience, introduction },
  ...
  useEffect(() => {
    if (experience) {
      setValue("experience", Number(experience));
    }
  }, [experience]);

  return (
    <>
      <form id="editOrganizationDetailsForm" key="editOrganizationDetailsForm" onSubmit={handleSubmit(onSubmit)}>
        <div>
