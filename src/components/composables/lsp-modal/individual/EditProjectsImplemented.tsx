...
export const EditProjectsImplemented: FunctionComponent = () => {
  const {
    register,
    setValue,
    handleSubmit,
  ...
  return (
    <>
      <form id="editProjectsImplementedForm" key="editProjectsImplementedForm" onSubmit={handleSubmit(onSubmit)}>
