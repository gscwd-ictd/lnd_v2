...
export const AddTrainingRequirementDocuments: FunctionComponent = () => {
  ...
  return (
    <>
      <form id="addTrainingDocumentsForm" key="addTrainingDocumentsForm" onSubmit={handleSubmit(onSubmit)}>
